...
export function BookingCalendar({ value, onChange }: BookingCalendarProps) {
  return (
    <div className="flex flex-col items-center gap-4 sm:gap-6 lg:flex-row lg:items-start">
      ...
      />
      <div className="flex flex-col items-center gap-1 rounded-[5px] border border-[#D4D0C7] bg-white px-4 py-3 text-center text-sm lg:items-start lg:text-left dark:border-[#263247] dark:bg-[#111827]">
        <CalendarDays
          className="size-4 text-[#5B7CFF] lg:hidden dark:text-[#6E8BFF]"
          aria-hidden="true"
        />
